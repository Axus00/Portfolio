...
if(idioma === 'es'){
    ...
    document.localStorage.setItem('opcionEscogida', 'es');
} else if(idioma === 'en'){
    ...
    document.localStorage.setItem('opcionEscogida', 'en');
};
};

//guardar la opción seleccionada
try{
const seleccion = localStorage.getItem('opcionEscogida')
if(seleccion === 'es'){
    dato1.innerText = traducciones.traduccionEspañol.es.parrafo1;
    dato2.innerText = traducciones.traduccionEspañol.es.parrafo2;
    dato3.innerText = traducciones.traduccionEspañol.es.parrafo3;
